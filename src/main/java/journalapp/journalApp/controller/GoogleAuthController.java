...
import journalapp.journalApp.service.UserDetailsServiceImpl;
import journalapp.journalApp.utilis.JwtUtil;
...
public class GoogleAuthController {
    ...
    public ResponseEntity<?> handleGoogleCallback(@RequestParam String code) {
        ...
        try {
            ...
            log.error("Exception occurred while Google Login", e);
